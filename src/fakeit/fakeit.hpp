 ...
 *  Generated: 2022-12-16 13:26:51.420648
...
namespace fakeit
{
    ...
    struct Invocation : Destructible
    {
        ...
        Invocation(unsigned int ordinal, MethodInfo &method) : _ordinal(ordinal), _method(method), _isVerified(false)
        {
        }
...
namespace fakeit
{
    ...
    struct ActualInvocation : public Invocation
    {
        ...
        ActualInvocation(unsigned int ordinal, MethodInfo &method, const typename fakeit::production_arg<arglist>::type... args) : Invocation(ordinal, method), _matcher{nullptr}, actualArguments{std::forward<arglist>(args)...}
        {
        }
...
namespace fakeit
{
    ...
    protected:
        ConcatenatedSequence(const Sequence &seq1, const Sequence &seq2) : s1(seq1), s2(seq2)
        {
        }
...
namespace fakeit
{
    ...
    struct VerificationEvent
    {
        ...
        VerificationEvent(VerificationType aVerificationType) : _verificationType(aVerificationType), _line(0)
        {
        }
    ...
    struct NoMoreInvocationsVerificationEvent : public VerificationEvent
    {
        ...
        NoMoreInvocationsVerificationEvent(
            ...
            std::vector<Invocation *> &anUnverifedIvocations) : VerificationEvent(VerificationType::NoMoreInvocations),
    ...
    struct SequenceVerificationEvent : public VerificationEvent
    {
        ...
        SequenceVerificationEvent(VerificationType aVerificationType,
                                  ...
                                  int anExpectedCount,
                                  int anActualCount) : VerificationEvent(aVerificationType),
    ...
    {
        UnexpectedMethodCallEvent(UnexpectedType unexpectedType, const Invocation &invocation) : _unexpectedType(unexpectedType), _invocation(invocation)
        {
        }
...
namespace fakeit
{
    ...
    {
        NoMoreInvocationsVerificationException(std::string format) : VerificationException(format)
        {
        }
    };
    ...
    {
        SequenceVerificationException(std::string format) : VerificationException(format)
        {
        }
    };
...
namespace fakeit
{
    ...
    struct PmdInfo
    {
        ...
        PmdInfo() : mdisp(0), pdisp(-1), vdisp(0)
        {
        }
    };
    ...
    {
        RTTIClassHierarchyDescriptor() : signature(0),
                                         attributes(0),
                                         numBaseClasses(0),
    ...
    {
#ifdef _WIN64
        RTTICompleteObjectLocator(const std::type_info &unused) : signature(0), offset(0), cdOffset(0),
...
#else
        RTTICompleteObjectLocator(const std::type_info &info) : signature(0), offset(0), cdOffset(0),
...
namespace fakeit
{
    ...
    struct MethodProxy
    {
        ...
        MethodProxy(unsigned int id, unsigned int offset, void *vMethod) : _id(id),
                                                                           _offset(offset),
                                                                           _vMethod(vMethod)
        {
        }
...
namespace fakeit
{
    ...
    public:
        InvocationHandlers(
            ...
            std::vector<unsigned int> &offsets) : _methodMocks(methodMocks), _offsets(offsets)
        {
    ...
    struct DynamicProxy
    {
        ...
        DynamicProxy(C &inst) : instance(inst),
        ...
        void stubDataMember(DataType C::*member, const arglist &...initargs)
        {
            ...
            _members.push_back(
                std::shared_ptr<DataMemeberWrapper<DataType, arglist...>>{new DataMemeberWrapper<DataType, arglist...>(memberPtr,
                                                                                                                       initargs...)});
        }
    ...
    private:
        ...
        public:
            DataMemeberWrapper(DataType *dataMem, const arglist &...initargs) : dataMember(dataMem)
            {
...
namespace fakeit
{
    ...
    struct TupleDispatcher
    {
        ...
        template <std::size_t I, typename TupleType1, typename TupleType2, typename FunctionType, typename = typename std::enable_if<I != std::tuple_size<typename std::remove_reference<TupleType1>::type>::value>::type>
...
namespace fakeit
{
    ...
    {
        static const bool value =
            std::is_default_constructible<typename naked_type<C>::type>::value && !std::is_abstract<typename naked_type<C>::type>::value;
    };
        ...
        static C &value()
        {
            ...
            class Exception : public DefaultValueInstatiationException
            {
                virtual std::string what() const
                    ...
                    override
                {
                    return (std::string("Type ") + std::string(typeid(C).name()) + std::string(" is not default constructible. Could not instantiate a default return value")).c_str();
                }
            };
    ...
    namespace internal
    {
        ...
        struct ApproxEqCreator
        {
            ...
            ApproxEqCreator(T &&expectedRef, U &&expectedMarginRef)
                : _expectedRef(std::forward<T>(expectedRef)), _expectedMarginRef(std::forward<U>(expectedMarginRef))
            {
            }
            ...
            TypedMatcher<ActualT> *createMatcher() const
            {
                struct Matcher : public TypedMatcher<ActualT>
                {
                    ...
                    Matcher(ExpectedTRef expected, ExpectedMarginTRef expectedMargin)
                        : _expected{std::forward<ExpectedTRef>(expected)}, _expectedMargin{std::forward<ExpectedMarginTRef>(expectedMargin)}
                    {
                    }
...
namespace fakeit
{
    ...
    class RecordedMethodBody : public MethodInvocationHandler<R, arglist...>, public ActualInvocationsSource, public ActualInvocationsContainer
    {
        ...
        struct MatchedInvocationHandler : ActualInvocationHandler<R, arglist...>
        {
            ...
            MatchedInvocationHandler(typename ActualInvocation<arglist...>::Matcher *matcher,
                                     ActualInvocationHandler<R, arglist...> *invocationHandler) : _matcher{matcher}, _invocationHandler{invocationHandler}
            {
            }
    ...
    public:
        RecordedMethodBody(FakeitContext &fakeit, std::string name) : _fakeit(fakeit), _method{MethodInfo::nextMethodOrdinal(), name} {}
...
namespace fakeit
{
    ...
    struct Repeat : Action<R, arglist...>
    {
        ...
        Repeat(std::function<R(typename fakeit::test_arg<arglist>::type...)> func) : f(func), times(1)
        {
        }

        Repeat(std::function<R(typename fakeit::test_arg<arglist>::type...)> func, long t) : f(func), times(t)
        {
        }
    ...
    struct RepeatForever : public Action<R, arglist...>
    {
        ...
        RepeatForever(std::function<R(typename fakeit::test_arg<arglist>::type...)> func) : f(func)
        {
        }
        ...
        GetAssigner(R &&r, helper::ArgValue<T, N>... arg_vals)
        {
            ...
            public:
                Lambda(R &&r, helper::ArgValue<T, N>... arg_vals)
                    : ret{std::forward<R>(r)}, vals_tuple{std::forward<helper::ArgValue<T, N>>(arg_vals)...} {}
...
namespace fakeit
{
    ...
    public:
        ...
        template <typename Head>
        typename std::enable_if<
            IsMatcherCreatorTypeCompatible<typename naked_type<Head>::type>::value, void>::type
        ...
        template <typename Head>
        typename std::enable_if<
            std::is_same<AnyMatcher, typename naked_type<Head>::type>::value, void>::type
...
namespace fakeit
{
        ...
        public:
            Implementation(Context *stubbingContext)
                : _stubbingContext(stubbingContext),
                  ...
                  _invocationMatcher{
                      new DefaultInvocationMatcher<arglist...>()},
                  _commited(false)
            {
            }
    ...
    protected:
        ...
        typename std::enable_if<
            sizeof...(matcherCreators) == sizeof...(arglist), void>::type
    ...
    template <typename... arglist>
    class MockingContext<void, arglist...> : public MethodMockingContext<void, arglist...>
    {
        MockingContext &operator=(const MockingContext &) = delete;
...
namespace fakeit
{
    ...
    private:
        ...
        MockImpl(FakeitContext &fakeit, C &obj, bool isSpy)
            : _instanceOwner(isSpy ? nullptr : asFakeObject(&obj)), _proxy{obj}, _fakeit(fakeit) {}
...
namespace fakeit
{
    ...
    public:
        ...
        template <int id, typename R, typename T, typename... arglist, class = typename std::enable_if<!std::is_void<R>::value && std::is_base_of<T, C>::value>::type>
...
namespace fakeit
{
    ...
    class WhenFunctor
    {
        ...
        struct StubbingChange
        {
            ...
            StubbingChange(const StubbingChange &other) : _xaction(other._xaction)
            {
            }
    ...
    public:
        ...
        struct MethodProgress : MethodStubbingProgress<R, arglist...>
        {
            ...
            MethodProgress(const MethodProgress &other) : _progress(other._progress), _context(other._context)
            {
            }

            MethodProgress(StubbingContext<R, arglist...> &xaction) : _progress(new StubbingChange(xaction)), _context(xaction)
            {
            }
...
namespace fakeit
{
    ...
    private:
        ...
        SequenceVerificationExpectation(
            ...
            std::vector<Sequence *> &expectedPattern) : _fakeit(fakeit),
...
namespace fakeit
{
    ...
    class SequenceVerificationProgress
    {
        ...
        SequenceVerificationProgress(
            ...
            std::vector<Sequence *> &allSequences) : SequenceVerificationProgress(new SequenceVerificationExpectation(fakeit, sources, allSequences))
        {
        }
...
namespace fakeit
{
    ...
    public:
        UsingProgress(fakeit::FakeitContext &fakeit, InvocationsSourceProxy source) : _fakeit(fakeit),
                                                                                      _sources(source)
        {
        }
    ...
    class VerifyNoOtherInvocationsVerificationProgress
    {
        ...
        private:
            ...
            VerifyNoOtherInvocationsExpectation(VerificationEventHandler &fakeit,
                                                std::vector<ActualInvocationsSource *> mocks) : _fakeit(fakeit),
                                                                                                _mocks(mocks),
                                                                                                _line(0),
                                                                                                _isVerified(false)
            {
        ...
        VerifyNoOtherInvocationsVerificationProgress(VerifyNoOtherInvocationsExpectation *ptr) : _ptr(ptr)
        {
        }
